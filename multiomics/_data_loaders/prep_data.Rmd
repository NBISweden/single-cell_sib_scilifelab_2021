...
scATAC_gene_act[,'gene'] <- rownames(scATAC_gene_act)
scATAC_gene_act <- scATAC_gene_act[c('gene',str_subset(colnames(scATAC_gene_act), 'gene', negate = TRUE))]
```
...
Multiome_ATAC_gene_act[,'gene'] <- rownames(Multiome_ATAC_gene_act)
Multiome_ATAC_gene_act <- Multiome_ATAC_gene_act[c('gene',str_subset(colnames(Multiome_ATAC_gene_act), 'gene', negate = TRUE))]
```
